...
class DetailedDescription(models.Model):
    ...
    price = models.DecimalField(
        max_digits=10, decimal_places=2, default=20000, verbose_name="قیمت"
    )
...
class PassengerDetail(models.Model):
    ...
    payment = models.DecimalField(
        max_digits=10, decimal_places=2, default=50, verbose_name="پرداخت"
    )
...
class Card(models.Model):
    card_number = models.CharField(
        primary_key=True, max_length=16, verbose_name="شماره کارت"
    )
...
class NetBanking(models.Model):
    username = models.CharField(
        primary_key=True, max_length=16, verbose_name="نام کاربری"
    )
...
class Transaction(models.Model):
    ...
    payment_method = models.CharField(
        max_length=15, blank=True, verbose_name="روش پرداخت"
    )
